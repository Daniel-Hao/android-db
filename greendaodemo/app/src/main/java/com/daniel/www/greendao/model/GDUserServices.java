...
// KEEP INCLUDES END
/**
 * Entity mapped to table GDUSER_SERVICES.
 */
public class GDUserServices {
    ...
    private transient GDUserServicesDao myDao;
    ...
    public GDUserServices() {
    }

    public GDUserServices(Long id) {
        this.id = id;
    }

    public GDUserServices(Long id, String user_id, String service_code, long user_info_id) {
        this.id = id;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getGDUserServicesDao() : null;
    }
